  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
              ...
              <div className="bg-white rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col sm:grid sm:grid-cols-3 gap-3 sm:gap-4">
                    <div className="flex sm:block items-center justify-between sm:text-center bg-blue-50 p-3 sm:p-4 rounded-lg border border-blue-100">
                      <span className="text-sm sm:hidden text-gray-600">Tiempo</span>
                      <div className="text-xl sm:text-2xl font-bold text-blue-700">{formatCookTime(recipe.cookTime)}</div>
                      <span className="hidden sm:block text-sm text-gray-700 font-medium mt-1">Tiempo</span>
                    </div>
                    <div className="flex sm:block items-center justify-between sm:text-center bg-green-50 p-3 sm:p-4 rounded-lg border border-green-100">
                      <span className="text-sm sm:hidden text-gray-600">Calorías</span>
                      <div className="text-xl sm:text-2xl font-bold text-green-700">{recipe.nutrition.calories}</div>
                      <span className="hidden sm:block text-sm text-gray-700 font-medium mt-1">Calorías</span>
                    </div>
                    <div className="flex sm:block items-center justify-between sm:text-center bg-orange-50 p-3 sm:p-4 rounded-lg border border-orange-100">
                      <span className="text-sm sm:hidden text-gray-600">Ingredientes</span>
                      <div className="text-xl sm:text-2xl font-bold text-orange-700">{recipe.ingredients.length}</div>
                      <span className="hidden sm:block text-sm text-gray-700 font-medium mt-1">Ingredientes</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Botones de acción */}
        <div className="p-4 md:p-6 border-t border-gray-200 bg-white rounded-b-xl">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
            {/* Parte siempre visible (fecha + autor + botón expandir) */}
            <div className="w-full md:w-auto flex items-center justify-between md:justify-start">
              ...
              {/* Botón expandir/contraer solo en móvil */}
              <button
            ...
            <div className={`${footerExpanded ? 'flex' : 'hidden'} md:flex flex-col md:flex-row gap-2 justify-end w-full md:w-auto`}>
              <button
                onClick={onClose}
