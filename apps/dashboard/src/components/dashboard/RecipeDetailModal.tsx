// apps/dashboard/src/components/dashboard/RecipeDetailModal.tsx
...
const RecipeDetailModal: React.FC<RecipeDetailModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col border border-blue-200">
                ...
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <div className="text-lg font-bold text-blue-700">{formatCookTime(recipe.cookTime)}</div>
                      <div className="text-xs text-gray-600">Tiempo</div>
                    </div>
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <div className="text-lg font-bold text-blue-700">{recipe.nutrition.calories}</div>
                      <div className="text-xs text-gray-600">Calorías</div>
                    </div>
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <div className="text-lg font-bold text-blue-700">{recipe.ingredients.length}</div>
            ...
            <div className="space-y-6">
                ...
                <ol className="space-y-4">
                  {recipe.instructions.map((instruction, index) => (
                    <li key={index} className="flex">
                      <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-blue-100 text-blue-800 rounded-full font-bold mr-4">
                        {index + 1}
                      </div>
                      <div className="pt-1">
              ...
              <div className="bg-white rounded-lg border border-blue-100 p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="text-sm font-medium text-gray-600 mb-2">Categorías:</h4>
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-gray-600 mb-2">Etiquetas:</h4>
                    <div className="flex flex-wrap gap-2">
        ...
        {/* Botones de acción */}
        <div className="p-6 border-t border-blue-200 bg-white rounded-b-xl flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            ...
            <button
              onClick={onDelete}
              className="px-5 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium flex items-center"
            >
