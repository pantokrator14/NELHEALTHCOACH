...
const sections: {
...
}[] = [
  {
    ...
    questions: [
      { text: '¿El primer alimento que consumes en el día es de sabor dulce (azúcar o carbohidrato)?', type: 'yesno' },
      ...
      { text: '¿Haces más de 5 comidas al día? ¿Comes cada 3-4 horas?', type: 'yesno' },
  ...
  },
  {
    ...
    questions: [
      { text: '¿Lo primero que ves al despertar es tu celular?', type: 'yesno' },
      ...
      { text: '¿Utilizas algún tipo de tecnología Wifi, 2G, 3G, 4G, 5G y/o luz artificial durante la noche?', type: 'yesno' },
      { text: '¿Exponerte al sol te hace daño (sufres quemadas)?', type: 'yesno' },
      ...
      { text: '¿Haces grounding (caminar descalzo sobre hierba, tierra, o arena) menos de 30 minutos al día?', type: 'yesno' },
      { text: '¿Utilizas filtros de luz azul en tus dispositivos electrónicos (modo noche, aplicaciones) por la noche?', type: 'yesno' },
    ],
  },
  {
    ...
    questions: [
      ...
      { text: '¿Duermes menos de 4 horas?', type: 'yesno' },
      { text: '¿Haces cenas copiosas?', type: 'frequency' },
      { text: '¿Te acuestas inmediatamente después de cenar?', type: 'frequency' },
      { text: '¿Tu horario de sueño es regular? (¿Te acuestas y levantas más o menos a la misma hora todos los días, incluidos fines de semana?)', type: 'yesno' },
    ],
  },
  {
    ...
    questions: [
      { text: 'Al hacer llamadas por celular ¿te lo pegas a la oreja?', type: 'yesno' },
      ...
      { text: '¿Tienes piel sensible o con erupciones?', type: 'yesno' },
      { text: '¿Tienes taquicardia o arritmia?', type: 'yesno' },
      { text: '¿Tienes problemas de presión arterial?', type: 'yesno' },
      { text: '¿Tienes colon irritable?', type: 'yesno' },
      { text: '¿Tienes pérdida auditiva, oyes un zumbido (tinitus) o te duelen los oídos?', type: 'yesno' },
    ],
  },
  {
