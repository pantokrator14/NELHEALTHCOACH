                    ...
                    <div key={index} className="bg-white p-6 rounded-lg border border-blue-100">
                      ...
                      <div className="space-y-3">
                        {item.options.map(option => (
                          <label key={option.value} className="flex items-center p-3 hover:bg-blue-50 rounded-lg transition-colors">
                            <input
                              type="radio"
                              value={option.value}
                              {...register(item.field)}
                              className="mr-3 text-blue-600 focus:ring-blue-700 h-4 w-4"
                            />
